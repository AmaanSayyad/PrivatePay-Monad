  ...
  return (
    <div className="overflow-hidden rounded-4xl bg-oasis-blue ">
      <div className="w-full rounded-2xl h-14 p flex items-center justify-center gap-2 text-sm text-white">
        ...
        This transactions benefit monad network
      </div>
      <div
        className={
      ...
      >
        ...
        <div className="flex flex-col w-full">
          <TxItem
            ...
            chainImg={MONAD_LOGO_ICON}
            title={"trivial.jane.privatepay.monad - Deposit"}
            isNounsies
          ...
          <TxItem
            tokenImg={MONAD_LOGO_ICON}
            chainImg={MONAD_LOGO_ICON}
            title={"xx.jane.privatepay.monad - Deposit"}
            isNounsies
          ...
          <TxItem
            tokenImg={MONAD_LOGO_ICON}
            chainImg={MONAD_LOGO_ICON}
            title={"zes.hui.privatepay.monad - Deposit"}
            isNounsies
          ...
          <TxItem
            tokenImg={MONAD_LOGO_ICON}
            chainImg={MONAD_LOGO_ICON}
            title={"pol.manda.privatepay.monad - Deposit"}
            isNounsies
          ...
          <TxItem
            tokenImg={MONAD_LOGO_ICON}
            chainImg={MONAD_LOGO_ICON}
            title={"joi.mike.privatepay.monad - Deposit"}
            isNounsies
